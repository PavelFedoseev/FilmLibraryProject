...
class ReminderBroadcast : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val outIntent = Intent(context, FilmLibraryActivity::class.java).apply { flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK }
        outIntent.putExtra(BUNDLE_OUT, bundle)
        val activityIntent = PendingIntent.getActivity(context, filmItem?.filmId?:1, outIntent, PendingIntent.FLAG_UPDATE_CURRENT )
